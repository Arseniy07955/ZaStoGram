...
def main() -> int:
    ...
    require_text(ENGINE, "ProxyRuntimeStateStore.markEndpointFailure(currentProxy, ProxyCheckDiagnostics.CONNECTING_TIMEOUT)", "connecting timeout must become endpoint failure/backoff", failures)
